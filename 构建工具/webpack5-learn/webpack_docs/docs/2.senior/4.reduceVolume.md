...
## Tree Shaking【生产环境webpack 默认开启无需配置】
优化点：（第三方工具库，整个引入，提高了体积）
...
**注意：它依赖 `ES Module`。**commonjs没法做

### 怎么用

Webpack 已经默认开启了这个功能，无需其他配置。

## Babel【开发、生产】（优化点：Babel为编译的每个文件都插入了辅助代码）
解决：辅助代码作为一个独立模块，来避免重复引入
